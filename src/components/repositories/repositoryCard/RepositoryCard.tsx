...
const RepositoryCard: React.FC<RepositoryCardType> = ({
  avatar,
  title,
  link,
  starCount,
  ...
  return (
    <div className={styles.block_repository_card}>
      ...
      <div className={styles.repository_card_text_block}>
        ...
        <div>
          <Link
            className={styles.repository_card_link_to_profile}
            to={`/repo/${owner}/${title}`}
          >
            {owner}
          </Link>
